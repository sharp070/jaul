...
<!----------META---------->
     ...
     <body>
        <header class="subject-page science">
          <h1>SCIENCE</h1>
          <nav>
            <ul>
        ...
        <div class="topics">
          <nav>
          <ul>
            <li><a href="index.php" class="active">Reproduction</a></li>
            <li><a href="#">Drug Use and Abuse</a></li>
         ...
         <div class="item-box reveals">         
           <div class="reveal-wrapper">
             <a href="#" data-target="#subTopic1" data-toggle="modal"><div class="reveal-content">
               <iframe width="100%" height="100%" src="https://www.youtube.com/embed/G0ZuCilCu3E?controls=0"></iframe>
                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
            </div></a>
             <div class="reveal-top">
                   <h1>Sexual Reproduction in Humans</h1>
             </div>
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header">
                        ...
                        <h4 class="modal-title">Sexual Reproduction in Humans</h4>
                      </div>
                      <div class="modal-body">
                        <iframe width="530" height="320" frameborder="0" allowfullscreen src="https://www.youtube.com/embed/G0ZuCilCu3E"></iframe>
                      </div>
                    </div>
                  </div>
                </div>
           ...
           <div class="reveal-wrapper">
             <a href="#" data-target="#subTopic2" data-toggle="modal"><div class="reveal-content">
               <iframe width="100%" height="100%" src="https://www.youtube.com/embed/h82ltr84_Yg?controls=0"></iframe>
                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
            </div></a>
             <div class="reveal-top">
                   <h1>Pregnancy</h1>
             ...
             <div id="subTopic2" class="modal fade">
               <div class="modal-dialog">
                 <div class="modal-content">
                   <div class="modal-header">
                     <button type="button" class="close" data-dismiss="modal" aria-hidden="true">X</button>
                     <h4 class="modal-title">Pregnancy</h4>
                   </div>
                   <div class="modal-body">
                     <iframe width="530" height="320" frameborder="0" allowfullscreen src="https://www.youtube.com/embed/h82ltr84_Yg"></iframe>
                   </div>
                 </div>
               </div>
             </div>
           ...
           <div class="reveal-wrapper">
             <a href="#" data-target="#subTopic3" data-toggle="modal"><div class="reveal-content">
               <iframe width="100%" height="100%" src="https://www.youtube.com/embed/exVUM5LABQg?controls=0"></iframe>
                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
            </div></a>
             <div class="reveal-top">
                   <h1>Sexual Maturity</h1>
             </div>
             ...
             <div id="subTopic3" class="modal fade">
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">X</button>
                        <h4 class="modal-title">Sexual Maturity</h4>
                      </div>
                      <div class="modal-body">
                        <iframe width="530" height="320" frameborder="0" allowfullscreen src="https://www.youtube.com/embed/exVUM5LABQg"></iframe>
                      </div>
                    </div>
                  </div>
                </div>
           ...
           <div class="reveal-wrapper">
             <a href="#" data-target="#subTopic4" data-toggle="modal"><div class="reveal-content">
               <iframe width="100%" height="100%" src="https://www.youtube.com/embed/2ycl2E9r-_o?controls=0"></iframe>
                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
            </div></a>
             <div class="reveal-top">
                   <h1>Sexual Reproduction in Plants</h1>
             </div>
             ...
             <div id="subTopic4" class="modal fade">
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">X</button>
                        <h4 class="modal-title">Sexual Reproduction in Plants</h4>
                      </div>
                      <div class="modal-body">
                        <iframe width="530" height="320" frameborder="0" allowfullscreen src="https://www.youtube.com/embed/2ycl2E9r-_o"></iframe>
                      </div>
                    </div>
                  </div>
                </div>
